...
class Help(commands.Cog):
	...
	async def help(self, ctx):
		...
		embed.add_field(name = '\nCustomizable Mode:      __**`Latest update!!`**__', value = f'Use `{prefixes[str(ctx.guild.id)]}start custom <rounds> <participants> <draw_time> <guess_time>` (Same command with just more parameters)', inline = False)
